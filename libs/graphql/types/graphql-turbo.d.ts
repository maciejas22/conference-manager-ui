...
declare module 'gql.tada' {
 interface setupCache {
    ...
    "\n  fragment ConferenceDetailsFragment on Conference {\n    title\n    startDate\n    endDate\n    location\n    website\n    acronym\n    additionalInfo\n    participantsCount\n    participantsLimit\n    eventsCount\n    registrationDeadline\n    ticketPrice\n  }\n":
      TadaDocumentNode<{ title: string; startDate: string; endDate: string; location: string; website: string | null; acronym: string | null; additionalInfo: string | null; participantsCount: number; participantsLimit: number | null; eventsCount: number; registrationDeadline: string | null; ticketPrice: number | null; }, {}, { fragment: "ConferenceDetailsFragment"; on: "Conference"; masked: true; }>;
    ...
    "\n  fragment ConferenceFormData on Conference {\n    id\n    title\n    startDate\n    endDate\n    location\n    website\n    acronym\n    additionalInfo\n    participantsLimit\n    registrationDeadline\n    ticketPrice\n    agenda {\n      id\n      startTime\n      endTime\n      event\n      speaker\n    }\n    files {\n      key\n      size\n      url\n    }\n  }\n":
      TadaDocumentNode<{ id: number; title: string; startDate: string; endDate: string; location: string; website: string | null; acronym: string | null; additionalInfo: string | null; participantsLimit: number | null; registrationDeadline: string | null; ticketPrice: number | null; agenda: { id: number; startTime: string; endTime: string; event: string; speaker: string; }[]; files: { key: string; size: number; url: string; }[]; }, {}, { fragment: "ConferenceFormData"; on: "Conference"; masked: true; }>;
