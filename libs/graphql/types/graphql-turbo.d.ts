...
declare module 'gql.tada' {
 interface setupCache {
    ...
    "\n  query GetConferences($filters: ConferencesFilters, $page: Page, $sort: Sort) {\n    conferences(filters: $filters, page: $page, sort: $sort) {\n      data {\n        id\n        title\n        acronym\n        startDate\n        endDate\n        location\n        participantsCount\n        registrationDeadline\n      }\n      meta {\n        page {\n          totalItems\n          totalPages\n        }\n      }\n    }\n  }\n":
      TadaDocumentNode<{ conferences: { data: { id: number; title: string; acronym: string | null; startDate: string; endDate: string; location: string; participantsCount: number; registrationDeadline: string | null; }[]; meta: { page: { totalItems: number; totalPages: number; }; }; }; }, { sort?: { order: "ASC" | "DESC"; column: string; } | null | undefined; page?: { size: number; number: number; } | null | undefined; filters?: { title?: string | null | undefined; associatedOnly?: boolean | null | undefined; } | null | undefined; }, void>;
